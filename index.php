            ...
            <div class="cs_slide">
              <div class="cs_service cs_style_1 cs_type_1 cs_pt_25 cs_pl_25 cs_pr_25 cs_pb_15 bg-white cs_transition_4 shadow cs_mb_25">
                ...
                <div class="cs_service_iconbox d-flex align-items-center cs_mb_20">
                  ...
                  <h2 class="cs_lh_base cs_fs_20 cs_fs_lg_18 m-0"><a href="services-details.html" class="inline-block">Risk Management <br>Consulting</a></h2>
                </div>
                <p class="cs_mb_20">Our expert consultants work closely with you to develop tailored financial strategies that align with your short-term and long-term aspirations.</p>
                <div class="text-primary">
                  <a href="services-details.html" class="cs_post_btn_2 d-inline-flex justify-content-between align-items-center cs_column_gap_10">
            ...
            <div class="cs_slide">
              <div class="cs_service cs_style_1 cs_type_1 cs_pt_25 cs_pl_25 cs_pr_25 cs_pb_15 bg-white cs_transition_4 shadow cs_mb_25">
                ...
                <div class="cs_service_iconbox d-flex align-items-center cs_mb_20">
                  ...
                  <h2 class="cs_lh_base cs_fs_20 cs_fs_lg_18 m-0"><a href="services-details.html" class="inline-block">Legal <br>Consulting</a></h2>
                </div>
                <p class="cs_mb_20">Our expert consultants work closely with you to develop tailored financial strategies that align with your short-term and long-term aspirations.</p>
                <div class="text-primary">
                  <a href="services-details.html" class="cs_post_btn_2 d-inline-flex justify-content-between align-items-center cs_column_gap_10">
              ...
              <div class="cs_post cs_style_1 bg-white shadow-sm cs_mb_30">
                ...
                <div class="cs_post_in">
                  <div class="cs_post_info cs_pl_33 cs_pr_33 cs_pt_40 cs_pb_35">
                    ...
                    <a href="blog-details.html" class="cs_post_btn_2 d-inline-flex justify-content-between align-items-center cs_column_gap_10 ">
                      <span class="cs_post_btn-text">Read More</span>
                      <svg width="16" height="10" viewBox="0 0 16 10" fill="none" xmlns="http://www.w3.org/2000/svg">
